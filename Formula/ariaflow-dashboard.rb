class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.288.tar.gz"
  sha256 "26bf4ede797b369cb2530b2723b30df453ec2350c7ecb311a15b760af9b0ef6d"
  version "0.1.288"
  license "MIT"
  depends_on "python"
