class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.287.tar.gz"
  sha256 "5823bc249848909d0bf64eed9a97022cf17b3ee9df986b0707a6fa88d46c2ebf"
  version "0.1.287"
  license "MIT"
  depends_on "python"
