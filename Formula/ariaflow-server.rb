class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.181.tar.gz"
  sha256 "e23587159adebc63a226a0705ef539f6362f91cded575b891688a08c8786ea32"
  version "0.1.181"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
