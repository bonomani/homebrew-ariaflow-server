class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.175.tar.gz"
  sha256 "00c62f9d45eae0b6cd8609bed4c990be259810f51ad6665d047d35c04d379471"
  version "0.1.175"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
